/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7f9a6c4f4193becf345e2c0ba42928d0)
// Runtime types generated with workerd@1.20260603.1 2025-03-10 nodejs_compat
interface __BaseEnv_Env {
	OAUTH_KV: KVNamespace;
	USER_TOKENS: KVNamespace;
	REGISTER_LIMITER: RateLimit;
	MCP_OBJECT: DurableObjectNamespace<import("./src/worker").LunchMoneyMCP>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "LunchMoneyMCP";
	}
